            ...
            for random_projection_experiment in [True, False]:
                ...
                for function_name in  ["random_ee", "random_ei", "desp", "hadsp", "ip_correct", "anti-oja_fast", "ip-anti-oja_fast"]:
                    ...
                    if random_projection_experiment:
                        url = f"sqlite:///rdn-proj_{sampler_name}_{spectral_representation}_{camel_to_snake(dataset_name)}_db.sqlite3"
                    else:
                        url = f"sqlite:///mod-proj_{sampler_name}_{spectral_representation}_{camel_to_snake(dataset_name)}_db.sqlite3"
